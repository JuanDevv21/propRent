export const colombia = {
  ...
  "Bolívar": [
    ...
    "Arroyohondo", "Barranco de Loba", "Calamar", "Cantagallo",
  ...
  "Boyacá": [
    ...
    "Tinjacá", "Tipacoque", "Toca", "Togüí", "Tópaga", "Tota", "Turmequé",
    "Tuta", "Tutazá", "Úmbita", "Ventaquemada", "Villa de Leyva",
    "Viracachá", "Zetaquira"
    ],
    "Caldas": [
    "Manizales", "Aguadas", "Anserma", "Aranzazu", "Belalcázar",
    ...
    "Casanare": [
    "Yopal", "Aguazul", "Chámeza", "Hato Corozal", "La Salina",
    ...
    "Silvia", "Sotara", "Sucre", "Suárez", "Timbío", "Timbiquí",
    ...
    "Guayabetal", "Gutiérrez", "Jerusalén", "Junín", "La Calera", "La Mesa",
    "La Palma", "La Peña", "La Vega", "Lenguazaque", "Macheta", "Madrid",
    "Manta", "Medina", "Mosquera", "Nariño", "Nemocón", "Nilo", "Nimaima",
    ...
    "Ubalá", "Ubaque", "Une", "Útica", "Vergara", "Vianí", "Villagómez",
    ...
    "Colombia", "Cubarral", "Cumaral", "El Calvario", "El Castillo",
    ...
    "Sardinata", "Silos", "Teorama", "Tibú", "Toledo", "Vergara",
    ...
    "Carcasí", "Cepitá", "Cerrito", "Charalá", "Charta", "Chimá",
    ...
    "La Paz", "Landázuri", "Lebrija", "Los Santos", "Macaravita", "Málaga",
